  ...
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent text-flashio-elements-item-contentDefault hover:text-flashio-elements-item-contentActive hover:bg-flashio-elements-item-backgroundActive':
          !selected,
        'bg-flashio-elements-item-backgroundAccent text-flashio-elements-item-contentAccent': selected,
      })}
      depth={depth}
...
function File({ file: { depth, name }, onClick, selected, unsavedChanges = false }: FileProps) {
  return (
    <NodeButton
      className={classNames('group', {
        'bg-transparent hover:bg-flashio-elements-item-backgroundActive text-flashio-elements-item-contentDefault': !selected,
        'bg-flashio-elements-item-backgroundAccent text-flashio-elements-item-contentAccent': selected,
      })}
      depth={depth}
      iconClasses={classNames('i-ph:file-duotone scale-98', {
        'group-hover:text-flashio-elements-item-contentActive': !selected,
      })}
      onClick={onClick}
    >
      <div
