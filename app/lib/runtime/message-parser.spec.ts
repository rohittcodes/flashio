...
describe('StreamingMessageParser', () => {
  ...
  describe('no artifacts', () => {
    ...
    ])('should correctly parse chunks and strip out flashio artifacts (%#)', (input, expected) => {
  ...
  describe('invalid or incomplete artifacts', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      ...
      ['Foo bar <bol', 'Foo bar '],
      ['Foo bar <flashio', 'Foo bar '],
      ['Foo bar <flashioa', 'Foo bar <flashioa'],
      ['Foo bar <flashioA', 'Foo bar '],
      ['Foo bar <flashioArtifacs></flashioArtifact>', 'Foo bar <flashioArtifacs></flashioArtifact>'],
      ['Before <oltArtfiact>foo</flashioArtifact> After', 'Before <oltArtfiact>foo</flashioArtifact> After'],
      ['Before <flashioArtifactt>foo</flashioArtifact> After', 'Before <flashioArtifactt>foo</flashioArtifact> After'],
    ])('should correctly parse chunks and strip out flashio artifacts (%#)', (input, expected) => {
      runTest(input, expected);
    });
  });
  ...
  describe('valid artifacts without actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Some text before <flashioArtifact title="Some title" id="artifact_1">foo bar</flashioArtifact> Some more text',
        {
      ...
      [
        ['Some text before <flashioArti', 'fact', ' title="Some title" id="artifact_1">foo</flashioArtifact> Some more text'],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
      ...
      [
        [
          'Some text before <flashioArti',
          'fac',
          't title="Some title" id="artifact_1"',
          ' ',
          '>',
          'foo</flashioArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          ' >fo',
          'o</flashioArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        [
          ...
          'o',
          '<',
          '/flashioArtifact> Some more text',
        ],
        {
          output: 'Some text before  Some more text',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
      ...
      [
        'Before <flashioArtifact title="Some title" id="artifact_1">foo</flashioArtifact> After',
        {
          output: 'Before  After',
          callbacks: { onArtifactOpen: 1, onArtifactClose: 1, onActionOpen: 0, onActionClose: 0 },
        },
  ...
  describe('valid artifacts with actions', () => {
    it.each<[string | string[], ExpectedResult | string]>([
      [
        'Before <flashioArtifact title="Some title" id="artifact_1"><flashioAction type="shell">npm install</flashioAction></flashioArtifact> After',
        {
          output: 'Before  After',
      ...
      [
        'Before <flashioArtifact title="Some title" id="artifact_1"><flashioAction type="shell">npm install</flashioAction><flashioAction type="file" filePath="index.js">some content</flashioAction></flashioArtifact> After',
        {
          output: 'Before  After',
